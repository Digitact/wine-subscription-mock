...
export default({caseSize, caseItems}) => {
    ...
    return(
        <Row className={diagramClass}>
            {caseSize === 6 ? (<>
                <img className='case-background' src={window.asset_url + SixFrameBackground}/>
                ...
                <img className='case-foreground' src={window.asset_url + SixFrameForeground}/> 
            </>) : (<>
                <img className='case-background' src={window.asset_url + TwelveFrameBackground}/>
                ...
                <img className='case-foreground' src={window.asset_url + TwelveFrameForeground}/> 
            </>)}
        </Row>
    )
}
